const Contact=()=>{
    return (
           ...
           <div class="w-full flex items-center justify-center my-12">
                <div class=" my-5 absolute top-40 bg-white dark:bg-gray-800 shadow-lg rounded py-16 lg:px-28 px-8">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <button class="mt-9 text-base font-semibold leading-none text-white py-4 px-10 bg-green-700 rounded hover:bg-green-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none">SUBMIT</button>
                    </div>
                </div>
            </div>
